...
void draw_wave(int n, int arr[])
{
   ...
   for(i = 1; i < n; ++i)
   {
      ...
      line0[2*i] = sf::Vertex(sf::Vector2f(2*(i-1), S-S/3.0-(arr[i-1]*u)));
      line0[2*i+1] = sf::Vertex(sf::Vector2f(2*i, S-S/3.0-(arr[i]*u)));
